  ...
  <div class="card bg-base-200 shadow-lg">
    <div class="card-body p-4">
      <div class="flex items-center justify-between mb-4">
        ...
        <span class="badge badge-primary">Top {{ limit }}</span>
      </div>
      ...
      <div v-else class="overflow-x-auto">
        <table class="table table-zebra w-full">
          ...
          <tbody>
            <tr v-for="(country, index) in displayCountries" :key="country.name">
              ...
              <td class="text-right">
                <span class="badge badge-sm" :class="getFatalityBadgeClass(country.fatalityRate)">
