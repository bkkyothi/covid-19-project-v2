<template>
  <header class="sticky top-0 z-40 bg-base-100/80 backdrop-blur-lg border-b border-base-300">
    <div class="flex items-center justify-between h-16 px-4 lg:px-6">
      <!-- Left: Mobile menu + Title -->
      <div class="flex items-center gap-4">
        <!-- Mobile Menu Button -->
        <button class="btn btn-ghost btn-square lg:hidden" @click="$emit('toggle-sidebar')">
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="menu menu-sm dropdown-content bg-base-200 rounded-box z-[1] mt-3 w-52 p-2 shadow-lg">
            <li><a>Settings</a></li>
            <li><a>About</a></li>
          </ul>
        </div>
...
/**
 * Header Component
 * Top navigation header with title, actions, and dark mode toggle
 */
interface Props {
  title?: string;
  subtitle?: string;
...
withDefaults(defineProps<Props>(), {
  title: 'Dashboard',
  subtitle: 'COVID-19 Global Statistics',
});
