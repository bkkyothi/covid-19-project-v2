  ...
  <aside class="sidebar w-64 min-h-screen bg-base-200 border-r border-base-300 flex flex-col">
    ...
    <nav class="flex-1 p-4">
      <ul class="menu menu-lg gap-1">
        ...
        <li>
          <NuxtLink to="/countries" class="flex items-center gap-3" active-class="active">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li>
          <NuxtLink to="/continents" class="flex items-center gap-3" active-class="active">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li>
          <NuxtLink to="/vaccines" class="flex items-center gap-3" active-class="active">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- <li>
          <NuxtLink to="/states" class="flex items-center gap-3" active-class="active">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="p-4 border-t border-base-300">
      ...
      <!-- Theme Toggle -->
      <button 
        class="btn btn-block btn-outline gap-2 mb-4" 
        @click="toggleTheme"
      >
      ...
      <div class="text-xs text-base-content/60">
        <p>Data from disease.sh</p>
        <p v-if="lastUpdated" class="mt-1">
